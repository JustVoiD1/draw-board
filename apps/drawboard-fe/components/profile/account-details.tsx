...
const AccountDetails = ({ profile }: {
    ...
    const profileAltText = profile.name
        .split(" ")
        .map((n) => n[0])
        .join("")
        .slice(0, 2)
        ...
        <Card className="md:col-span-1">
            ...
            <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
                    <div className="relative grid overflow-hidden  object-cover h-16 w-16 place-items-center rounded-full border border-border bg-muted text-lg font-semibold">
                        <img src={profile.photo} className='h-full w-full' alt={profileAltText} />
